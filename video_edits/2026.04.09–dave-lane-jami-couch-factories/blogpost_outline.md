...
- **The pattern beyond code**
  ...
  - <**Callout box**> — meta example: this post itself was produced by my own content factory. The goal isn't to generate AI slop — in stead a follow as well defined set of steps to systematically extract and deliver value from a long-form conversation. My goal isn't to make this a dark-factory, because I want to keep a strong hold on the content and style. Rather, I want it to save me time. Here are the steps in my current process:
    - gleaning key points from the video, 
    - organizing them into a coherent structure (which I review and edit where necessary)
    - converting that structure into prose (which I modify for tone and delete the emdashes :joy emoji:)
    - pushing it through to publishing
    - promoting it.
    This post started as a 70-minute interview transcript and a set of editing notes. You're looking at the output. If you like what you've seen, then the factory works.
