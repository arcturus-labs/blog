...
| Pattern | Example |
|---|---|
| Clear utility + specific outcome | "How to Cut RAG Latency in Half Without Sacrificing Recall" |
| Specificity / bounded claim | "What We Learned After 1,000 User Interviews" |
| Bounded curiosity gap | "The One Metric That Quietly Predicts LLM Feature Failure" |
| Negative framing / loss aversion | "Why Your Evaluation Metrics Are Misleading You" |
| Authority + evidence signal | "We Tested 5 LLM Evaluation Methods – Here's What Actually Works" |
| Audience-specific relevance | "A Guide to RAG Evaluation for Early-Stage Startups" |
| Plain language | "How We Built a Reliable LLM Pipeline" (vs. "Toward a Paradigm of Generative Reliability") |

**Avoid:** superlatives ("unbelievable," "shocking"), vague curiosity gaps ("You won't believe…"), bait-and-switch promises, anything salesy or corporate. The reader should feel trust, not skepticism, after reading the title.

The best titles might use one of these patterns or even sometimes combine 2–3 of them. Generate a few candidates if the current title is weak.
